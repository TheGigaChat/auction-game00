...
function Container15() {
  return (
    <section className="Container15 displayNone" id="Container15">
      <section className="items">
        ...
        <section className="frySection">
          <p>+218$</p>
          <img src={require("./img/container15img/fry.png")} alt="reload" />
        </section>
        ...
        <section className="soupSection">
          <p>+109$</p>
          <img src={require("./img/container15img/soup.png")} alt="reload" />
        </section>
