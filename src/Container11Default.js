...
function Container11Default() {
  return (
    <section className="Container11Default displayNone" id="Container11Default">
      <section className="items">
        ...
        <section className="oldBedSection">
          <p>+999$</p>
          <img src={require("./img/container11img/oldBed.png")} alt="reload" />
        </section>
...
export default Container11Default;
