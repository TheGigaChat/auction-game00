...
function Container14Default() {
  return (
    <section className="Container14Default displayNone" id="Container14Default">
      <section className="items">
        ...
        <section className="houseTVSection">
          <p>+599$</p>
          <img src={require("./img/container14img/houseTV.png")} alt="reload" />
        </section>
...
export default Container14Default;
